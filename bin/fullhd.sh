...
xrandr --output "$(xgetres monitor.center)" --mode fullhd    --rate "$(xgetres monitor.center.rate)" --pos 2160x2160 --rotate normal --primary \
       ...
       --output "$(xgetres monitor.right)"  --mode 3840x2160 --rate 60                               --pos 4080x2160 --rotate normal
