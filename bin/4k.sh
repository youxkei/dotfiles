#!/bin/sh
xrandr --output "$(xgetres monitor.center)" --mode 3840x2160 --rate "$(xgetres monitor.center.rate)" --pos 2160x2160 --rotate normal \
       ...
       --output "$(xgetres monitor.right)"  --mode 3840x2160 --rate 60                               --pos 6000x2160 --rotate normal --primary \
